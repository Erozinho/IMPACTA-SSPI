...
urlpatterns = [
    ...
    path('terrenos/terreno1/', views.terreno1, name="terreno1"),
    path('terrenos/terreno2/', views.terreno2, name="terreno2"),
    path('terrenos/terreno3/', views.terreno3, name="terreno3"),
